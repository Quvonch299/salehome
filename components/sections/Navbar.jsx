...
<h2 className='text-[24px]  max-sm:hidden'>Гид по недвижимости</h2>
            ...
            <div  className='text-[#654D31] font-bold flex gap-14 max-sm:gap-[16px]'>
                <span className='flex gap-[6px] items-center'>
                    <FaPhone size={24}/>
                    <h2 className='font-semibold text-[18px] leading-[100%] tracking-[0%] max-sm:hidden'>+7 978 221 26 88</h2>
                </span>
                <span className='flex gap-[6px] items-center'>
                <MdEmail size={24} />

                    <h2 className='font-semibold text-[18px] leading-[100%] tracking-[0%] max-sm:hidden'>info@gidrealter.ru</h2>
                </span>
            </div>
            <div>
